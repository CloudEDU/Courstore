...
Write-Host "Please, download the SQLite precompiled binary for Windows v3.8.4.2 from the SQLite.org site (http://www.sqlite.org/2014/sqlite-dll-win32-x86-3080402.zip), extract the sqlite3.dll file, and add it as Copy-Always Content to the root folder of the project."
