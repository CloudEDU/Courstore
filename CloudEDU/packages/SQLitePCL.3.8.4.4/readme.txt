Portable Class Library for SQLite. v3.8.4.4

Supports .NET Framework 4.5, Windows Store, Windows Phone 8 applications, Xamarin Android, Xamarin iOS, and PCL Projects targeting this platforms.

ADDITIONAL INSTRUCTIONS

.NET Framework 4.5
Please, download the SQLite precompiled binary for Windows v3.8.4.3 from the SQLite.org site (http://www.sqlite.org/2014/sqlite-dll-win32-x86-3080403.zip), extract the sqlite3.dll file, and add it as Copy-Always Content to the root folder of the project.
...
Windows Store 8.0
Please, verify that the extension SDK SQLite for Windows Runtime v3.8.4.3, from the SQLite.org site (http://www.sqlite.org/2014/sqlite-winrt-3080403.vsix), has been properly installed.

Windows Store 8.1
Please, verify that the extension SDK SQLite for Windows Runtime (Windows 8.1) v3.8.4.3, from the SQLite.org site (http://www.sqlite.org/2014/sqlite-winrt81-3080403.vsix), has been properly installed.

Windows Phone 8
Please, verify that the extension SDK SQLite for Windows Phone v3.8.4.3, from the SQLite.org site (http://www.sqlite.org/2014/sqlite-wp80-winrt-3080403.vsix), has been properly installed.
